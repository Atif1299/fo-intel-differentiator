...
Customer UI: [https://fo-intel-web-95044197271.us-central1.run.app](https://fo-intel-web-95044197271.us-central1.run.app)  
API: [https://fo-intel-api-95044197271.us-central1.run.app](https://fo-intel-api-95044197271.us-central1.run.app)  

### Answer-eval suite (live Cloud Run) — **10/10 passed** (2026-07-25, re-run after scrub + plain-text answers)

| Query | Result | Firms shown | Firm names (this run) | Notes |
|-------|--------|-------------|------------------------|-------|
| What type of family office is Matter Family Office? | ok | 1 | Matter Family Office | MFO grounded |
| Is ckandcompany a single-family office? | ok | 1 | ckandcompany Family Office | SFO grounded |
| What does Westerman Capital do? | ok | 1 | Westerman Capital | Named-firm only |
| List single-family offices with investment or venture signals | ok | 6 | Oval; Miami; Connors; MSD Partners; ckandcompany; Bezos | Multi-firm; see issue below |
| Which family offices are multi-family offices? | ok | 6 | Farther; Gacs; Alpha Capital; Matter; Jupiter Wealth; Clearstead | Multi-firm MFO list |
| List family offices in Texas or Dallas | ok | 4 | Legacy Knight; Adi; Sowell & Company; MSD Partners | Count varies by retrieval (was 3–5) |
| Which family offices have recent investment or hiring signals? | ok | 6 | Oval; Angeles; Farther; Alpha Capital; ckandcompany; Miami | Multi-firm signals |
| Name family offices that invest in real estate or private equity | ok | 3 | Equity Investment Group; Miami; Adi | Multi-firm mandate |
...
Firm counts are retrieval-dependent (not a fixed product cap). Suite pass rule is status + content checks + `min_records` where set.




### Post-scrub search smoke (live API `/search`)
